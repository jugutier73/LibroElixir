defmodule Util do
  ...
  @doc """
    Función para cuentar la cantidad de elementos de una colección 
    que cumplen un criterio dado como argumento.

    ## Parámetros
    - `coleccion`: Colección de elementos a procesar.
    - `aplicarCriterio`: Función que toma un elemento e indica si cumple un cierto criterio.
    - `valorCriterio`:  Valor de refencia para el criterio.
  ...
  @doc """
    Función para Compara dos elementos
    ...
    :menor  si elemento1 < elemento2
    :igual  si elemento1 == elemento2
    :mayor  si elemento1 > elemento2

    ## Ejemplo

    ```elixir
     Util.comparar(residuo1.tipo, residuo2.tipo) 
    ```

  """
  def comparar(elemento1, elemento2) when elemento1 < elemento2, do: :menor
  def comparar(elemento1, elemento2) when elemento1 > elemento2, do: :mayor
  def comparar(_, _), do: :igual
