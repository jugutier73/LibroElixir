defmodule Inclusivo do
  ...
  def contar([], cantidad), do: cantidad

  def contar([c | resto], cantidad)
       when c in [@simbolo_inclusivo_1, @simbolo_inclusivo_2] do
    contar(resto, cantidad + 1)
  end

  def contar([_ | resto], cantidad), do: contar(resto, cantidad)
